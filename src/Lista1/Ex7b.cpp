 ...
 int main()
 {
     ...
     while (!glfwWindowShouldClose(window))
     {
         ...
         // Poligono Preenchido - GL_TRIANGLES_FAN
         glUniform4f(colorLoc, 0.0f, 0.0f, 2.0f, 1.0f); // enviando cor para variável uniform inputColor
 ...
 int createCircle(int nPoints, float radius) {
    ...
    //Adicionando o centro do círculo
